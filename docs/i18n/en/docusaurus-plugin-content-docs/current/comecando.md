...
|---|---:|---|
| Game code | 30,066 lines in 40 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **6,561** lines | `wc -l public/js/game.js` |
| `main.js` | 2,516 lines | `wc -l public/js/main.js` |
...
| Maps in the registry | 9 | `MAPS` object in `maps.js` |
...
| Maps in the menu | 9 - 2 open in rounds, **7 in capture** | `MAPS` / `ctfMode` |
...
`package.json` has **106 scripts**. Keys prefixed with `//` explain why the adjacent command exists.
