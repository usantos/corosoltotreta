...
**10 human author identities** sign commits in this branch: `ruben-cytonic`, `Emerson Garrido`, `rubenmarcus`, `Ruben`, `Ruben Marcus`, `William Oliveira`, `Juan Versolato Lopes`, `Ubiracy`, `matheusgb`, `daltonfontes`. Automated identities are excluded. A Git author name is not necessarily one unique person.
