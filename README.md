...
|---|---:|---|
| Código do jogo | 30.849 linhas em 42 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Jogo | ES modules vanilla, **zero build** | 42 arquivos |
...
| `penitenciaria` | Penitenciária da Treta | **captura** | `map_penitenciaria.js` | 346 |
