...
|---|---:|---|
| Game code | 30,826 lines in 42 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **6,561** lines | `wc -l public/js/game.js` |
| `main.js` | 2,518 lines | `wc -l public/js/main.js` |
...
| Maps in the registry | 10 | `MAPS` object in `maps.js` |
| Visual harnesses in HTML | 15 | `git ls-files 'public/*.html' \| wc -l` |
| Harness scripts | 180 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
...
| Maps in the menu | 10 - 2 open in rounds, **8 in capture** | `MAPS` / `ctfMode` |
...
`package.json` has **107 scripts**. Keys prefixed with `//` explain why the adjacent command exists.
