...
**10 human author identities** sign commits in this branch: `ruben-cytonic`, `Emerson Garrido`, `rubenmarcus`, `Ruben`, `Ruben Marcus`, `William Oliveira`, `Juan Versolato Lopes`, `usantos`, `matheusgb`, `daltonfontes`. Automated identities are excluded. A Git author name is not necessarily one unique person.
...
| `penitenciaria` | Penitenciária da Treta | **capture** | `map_penitenciaria.js` | 323 |
